...
\subsection*{Part (c):}
	...
	\begin{questions}
		...
		\begin{solution}
			...
			\begin{align*}
				kxf_{k}(x)+x f_{k-1}(x) &= kx \sum_{n=k}^\infty \stirling{n}{k}x^n + x \sum_{n=k-1}^\infty \stirling{n}{k-1}x^n \\
				&= \sum_{n=k}^\infty k\stirling{n}{k}x^{n+1} + \sum_{n=k-1}^\infty \stirling{n}{k-1}x^{n+1} \\
				&= \sum_{n=k+1}^\infty k\stirling{n-1}{k}x^{n} + \sum_{n=k}^\infty \stirling{n-1}{k-1}x^{n} \\
				&= \sum_{n=k+1}^\infty (k\stirling{n-1}{k} + \stirling{n-1}{k-1}) x^{n} + k\stirling{k}{k}x^k \\
				&= \sum_{n=k+1}^\infty \stirling{n}{k} x^{n} + k x^k \\
				&= f_k(x)
			\end{align*}
